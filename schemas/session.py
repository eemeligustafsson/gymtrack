...
class SessionSchema(Schema):
    ...
    lengthInMinutes = fields.Integer(validate=validate_len_in_mins)
    stepsTaken = fields.Integer()
    pushUps = fields.Integer()
    pullUps = fields.Integer()
    otherExercises = fields.String(validate=[validate.Length(max=1000)])
    bodyWeightInKG = fields.Integer()
